...
def menushka():
    ...
    menu.add_button(' Начать ',main.main,shadow=True ,shadow_color=(0, 0, 100), background_color=(255,255,255))
    ...
    menu.add_button(color_menu.get_title(), color_menu, shadow=True, shadow_color=(0, 0, 100),
    ...
    color_menu.add_button(' Синий ', pygame_menu.events.BACK, shadow=True, shadow_color=(0, 0, 100),
                          background_color=(255, 255, 255))
