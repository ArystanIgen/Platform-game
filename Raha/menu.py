...
about_menu.add_image('rake.png', scale=(0.15, 0.15), scale_smooth=True)
...
about_menu.add_image('aleke.png',  scale=(0.15, 0.15))
about_menu.add_label('Iztay Almaz',font_color=(0,252,255),shadow_color=(0,0,0),shadow=True)
about_menu.add_vertical_margin(50)
about_menu.add_image('areke.png',  scale=(0.15, 0.15), scale_smooth=True)
