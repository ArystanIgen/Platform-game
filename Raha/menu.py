...
about_menu.add_button(' back ', pygame_menu.events.RESET,font_size=20,font_color=(255,0,0),shadow_color=(0,0,0,0),shadow=True,background_color=(0,0,0,0))
...
color_menu.add_button(' back ', pygame_menu.events.RESET,font_size=20,font_color=(255,255,255),shadow_color=(0,0,0,0),shadow=False,background_color=(0,0,0,0))
color_menu.set_sound(engine, recursive=True)
...
red_menu.add_button(' back ', pygame_menu.events.RESET,font_size=20,font_color=(255,255,255),shadow_color=(0,0,0,0),shadow=False,background_color=(0,0,0,0))
...
rules_menu.add_vertical_margin(100)
rules_menu.add_button(' back ', pygame_menu.events.RESET,font_size=20,font_color=(255,255,255),shadow_color=(0,0,0,0),shadow=False,background_color=(0,0,0,0))
rules_menu.set_sound(engine, recursive=True)

# информация о наших ботах

info_menu = pygame_menu.Menu(600, 800, "info", theme=mytheme)
menu.add_button(info_menu.get_title(), info_menu, font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,background_color=(0,0,0,0))

# череп
info_menu.add_vertical_margin(-200)
info_menu.add_label('skull',font_size=30,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(-300,0))
info_menu.add_vertical_margin(-35)
info_menu.add_image('enemie3.png',  scale=(2, 2),margin=(-170,0))
info_menu.add_vertical_margin(-35)
info_menu.add_label('our death blocks that',font_size=18,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(100,0))
info_menu.add_label('are vital to our hero',font_size=18,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(100,0))

# телепорт
info_menu.add_vertical_margin(100)
info_menu.add_label('teleport',font_size=30,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(-260,0))
info_menu.add_vertical_margin(-30)
info_menu.add_image('teleport.png',  scale=(1, 1),margin=(-100,0))
info_menu.add_vertical_margin(-30)
info_menu.add_label('if you step on it',font_size=18,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(110,0))
info_menu.add_label('it will throw the hero',font_size=18,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(140,0))
info_menu.add_label('to another area of the map',font_size=18,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(140,0))

#кубок
info_menu.add_vertical_margin(40)
info_menu.add_label('cup',font_size=30,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(-330,0))
info_menu.add_vertical_margin(-30)
info_menu.add_image('win.png',  scale=(0.9, 0.9),margin=(-200,0))
info_menu.add_vertical_margin(-30)
info_menu.add_label('the gift for your victory',font_size=18,font_color=(0,252,255),shadow_color=(255,0,0),shadow=True,margin=(90,0))

info_menu.add_vertical_margin(50)
info_menu.add_button(' back ', pygame_menu.events.RESET,font_size=20,font_color=(255,255,255),shadow_color=(0,0,0,0),shadow=False,background_color=(0,0,0,0))
